...
| UOW-05 | Adds payment, allocation, receipt, credit, and correction APIs/tables; must use the same audit, backup, and approval infrastructure. |
| UOW-06 | Adds penalty, delinquency, waiver, and reminder APIs/tables; reminder delivery remains through support intents until UOW-08. |
